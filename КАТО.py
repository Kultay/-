...
col = csv.writer(open("КАТО.csv", 'w', newline="", encoding="utf"))

for row in range(ws.nrows):
        col.writerow(ws.row_values(row))

with open ("КАТО.csv",'r',newline="", encoding="utf") as csv_file:
...
with open('КАТО.csv', 'w', newline="", encoding="utf") as csv_new:
